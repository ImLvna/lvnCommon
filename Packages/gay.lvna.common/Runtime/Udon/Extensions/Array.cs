...
namespace gay.lvna.common.udon.extensions
{
    public static class ArrayExtensions
    {
        ...
        public static T[] ConCat<T>(this T[] array, T[] other)
        {
            ...
            T[] newArray = new T[length + otherLength];

            array.CopyTo(newArray, 0);
            other.CopyTo(newArray, length);
        ...
        /// <para>
        /// Based on: <see href="https://learn.microsoft.com/en-us/dotnet/api/system.collections.generic.list-1.1tains?view=net-6.0">List&lt;T&gt;.Contains(T)</see>
        /// </para>
        /// </summary>
